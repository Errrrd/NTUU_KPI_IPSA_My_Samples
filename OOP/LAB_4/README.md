...
Варіант 20.
Описати клас «Зображення», у якому передбачити поле з назвою,
динамічний масив об’єктів типу «Коло» та розмірністю цього масиву.
...
про коло. Для одного з похідних класів передбачити можливість перетворення
типу до об’єкту другого похідного і навпаки.
Функцію з виведенням скороченої інформації у класах «Коло» та усіх
